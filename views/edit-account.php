...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <form action="?act=edit-password" method="post">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="old-pass" class="form-label">Mật khẩu cũ</label>
                            <input type="password" class="form-control" name="old-pass" id="old-pass" placeholder="Mật khẩu cũ">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" name="new-pass" id="new-pass" placeholder="Mật khẩu mới">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" name="confirm-pass" id="confirm-pass" placeholder="Nhập lại mật khẩu mới">
