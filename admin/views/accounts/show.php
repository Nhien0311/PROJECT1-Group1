                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="email" name="email" value="<?= $accounts['email']?>" disabled>
                                                        </div>
                                                    </div>
                                                    </div>
                                                    <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="role_id" name="role_id" value="<?= $accounts['role_id'] == 0 ? 'admin' : 'user'; ?>" disabled>
                                                        </div>
                                                    </div>
                                                    </div>
