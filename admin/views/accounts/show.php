...
<head>
    ...
    <title>Chi tiết tài khoản | Modelkit Store VN</title>
                                ...
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        ...
                                        <a href="?act=accounts/create" class="btn btn-soft-success material-shadow-none">
                                            <i class="ri-add-circle-line align-middle me-1"></i> Chi tiết tài khoản
                                        </a>
                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="user_name" name="user_name" value="<?= $accounts['user_name'] ?>" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="email" class="form-control" id="email" name="email" value="<?= $accounts['email'] ?>" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="password" class="form-control" id="password" name="password" value="<?= $accounts['password'] ?>" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="number" class="form-control" id="phone" name="phone" value="<?= $accounts['phone'] ?>" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="address" name="address" value="<?= $accounts['address'] ?>" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="number" class="form-control" id="role_id" name="role_id" value="<?= $accounts['role_id'] == 0 ? 'admin' : 'user'; ?>" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
