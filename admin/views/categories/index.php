...
<head>
    ...
    <title>Danh mục sản phẩm | Modelkit Store VN</title>
                            ...
                            <div class="h-100">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        ...
                                        <a href="?act=categories/create" class="btn btn-soft-success material-shadow-none">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div
                                                                        ...
                                                                        <a href="?act=categories/show&id=<?php echo $category['category_id']; ?>"
                                                                            class="link-success">
                                                                            <i class="ri-eye-line"></i>
                                                                        </a>

                                                                        <a href="?act=categories/edit&id=<?php echo $category['category_id']; ?>"
                                                                            class="link-success">
                                                                            <i class="ri-edit-2-line"></i>
                                                                        </a>

                                                                        <a href="?act=categories/delete&id=<?php echo $category['category_id']; ?>"
                                                                            class="link-danger"
